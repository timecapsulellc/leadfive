...
library UserManagementLib {
    ...
    function getUserDetails(
        ...
        details.withdrawableAmount = u.balance;
        details.directReferralsCount = u.directReferrals;
        details.teamSize = u.teamSize;
        details.packageLevel = uint256(u.packageLevel);
        details.joinTime = u.registrationTime;
        details.lastActivityTime = u.registrationTime;
        details.registrationTime = u.registrationTime;
