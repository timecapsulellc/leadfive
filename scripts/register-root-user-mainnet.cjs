...
async function main() {
        ...
        console.log(`📊 Earnings Cap: ${ethers.formatUnits(earningsCap, 6)} USDT`);e.log("🚀 LEADFIVE MAINNET - ROOT USER REGISTRATION");
    ...
    if (isRegistered) {
        ...
        console.log(`📊 Balance: ${ethers.formatUnits(userBalance, 18)} USDT`);
        console.log(`📊 Referrer: ${referrer}`);
        console.log(`📊 Direct Referrals: ${directReferrals}`);
        console.log(`📊 Team Size: ${teamSize}`);
        console.log(`📊 Total Earned: ${ethers.formatUnits(totalEarnings, 18)} USDT`);
        console.log(`📊 Earnings Cap: ${ethers.formatUnits(earningsCap, 18)} USDT`);
