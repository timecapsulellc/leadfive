...
/**
 * DEPLOY BASIC CONTRACTS ONLY
 * 
 * This script deploys only MockUSDT and OrphiCrowdFundV2 (the working contracts)
 */

async function main() {
    console.log("🚀 DEPLOYING BASIC ORPHI CROWDFUND CONTRACTS");
