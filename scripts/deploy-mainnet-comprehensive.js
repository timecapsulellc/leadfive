...
const MAINNET_CONFIG = {
    ...
    METAMASK_ADMIN: "0xD29ef4aE187AB9E07B7E0839CF64508A3D70A229",  // MetaMask Admin Wallet
...
async function main() {
    ...
    try {
        ...
        const deploymentData = {
            ...
            adminRoles: {
                owner: MAINNET_CONFIG.TREZOR_ADMIN,
                treasury: MAINNET_CONFIG.TREZOR_ADMIN,
                emergency: MAINNET_CONFIG.TREZOR_ADMIN,
                poolManager: MAINNET_CONFIG.TREZOR_ADMIN,
                upgrader: MAINNET_CONFIG.TREZOR_ADMIN
            },
