...
A production-ready, modular, and fully integrated DeFi dashboard for the OrphiChain BSC Mainnet contract.

## Features
- Modern, responsive UI/UX (React + Vite)
- Real-time Web3 integration (MetaMask, ethers.js)
- Modular dashboard: Earnings, Withdrawals, Matrix, Referrals, Team
...
## Web3 Integration
- Uses the OrphiCrowdFund BSC Mainnet contract
- All dashboard features fetch live data from the blockchain
- Wallet connection via MetaMask (auto-detects network)

## Customization
- Edit `src/contracts.js` for contract config/ABI
...
- See `DEPLOYMENT_NEXT_STEPS.md` for production deployment

---

For more details, see the implementation plan and audit reports in the project root.
