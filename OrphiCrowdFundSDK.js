...
// Updated for BSC Mainnet Integration - LIVE CONTRACT
...
export class OrphiCrowdFundSDK {
    constructor(provider, signer = null) {
        ...
        // MAINNET CONFIGURATION - LIVE CONTRACT
        ...
        // Optimized ABI for the live contract
        this.abi = [
    ...
    async getUserInfo(userAddress) {
        ...
        return {
            ...
            registrationTime: Date.now(), // Placeholder
            lastWithdrawal: 0, // Placeholder
    ...
    async getPackageAmounts() {
        // Return the 8 package amounts in USD (converted to wei)
        return [
    ...
    async registerUser(sponsorAddress, packageTier, paymentAmount) {
        ...
        // Convert tier (0-based to 1-based for the contract)
    ...
    // Convert USD to BNB (simplified - should use price oracle in production)
    usdToBNB(usdAmount) {
