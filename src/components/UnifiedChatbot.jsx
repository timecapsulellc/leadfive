...
const UnifiedChatbot = React.memo(
  ({
    userStats,
    account,
    userInfo,
    ...
    console.log(
      '[AIRA DEBUG] Enhanced chatbot with PhD-level knowledge initialized'
    );
    ...
    const personalities = {
      advisor: {
        ...
        greeting:
          "🌟 Welcome to your financial transformation! I'm your Revenue Advisor with 20+ years experience helping people build generational wealth. Ready to unlock your earning potential with our proven 4X system?",
      ...
      analyzer: {
        ...
        greeting:
          "📊 Data reveals everything! I'm your Network Analyzer, powered by Harvard-level analytical frameworks. Let me show you the hidden patterns in your network that lead to exponential growth!",
      ...
      mentor: {
        ...
        greeting:
          "🚀 Every millionaire started with a single decision! I'm your Success Mentor, trained by top performance coaches. Together, we'll transform your mindset and accelerate your journey to financial freedom!",
      ...
      strategist: {
        ...
        greeting:
          "💎 Strategic thinking creates generational wealth! I'm your Binary Strategist, combining German precision with IIT-level optimization. Let's architect your path to financial independence!",
    ...
    useEffect(() => {
      ...
      console.log('[ARIA DEBUG] Props received:', {
        userStats,
        account,
        userInfo,
        mode,
    ...
    const enhanceResponseByPersonality = (
      baseResponse,
      personalityType,
      userMessage
    ) => {
...
What specific aspect would you like to explore first? 🚀`;
    ...
    const generateAdvancedAIResponse = async userMessage => {
      ...
      try {
        // Try OpenAI service first if available
        if (OpenAIService.isReady()) {
          console.log('[AIRA] Using OpenAI service for response generation');
          response = await OpenAIService.getChatResponse(userMessage, updatedContext);
          
          // Add personality-specific enhancements
          const enhancedResponse = enhanceResponseByPersonality(
            response,
            currentPersonality,
            userMessage
          );
          ...
          console.log('[AIRA] Using enhanced knowledge base for response generation');
    ...
    console.log(
      '[ARIA DEBUG] About to render ARIA chatbot with personality:',
      currentPersonalityData.name
    );

    return (
      <div className={`aria-chatbot ${mode} ${position}`}>
        {/* Chat Toggle Button */}
        <button
        ...
        {isOpen && (
          ...
          >
            ...
            >
              ...
              <div
                className="aria-header-controls"
              ...
              <>
                ...
                >
                  {messages.map(message => {
                    const MessagePersonalityIcon = message.personality
                      ? personalities[message.personality].icon
                      : FaRobot;
                    return (
                      <div
                        key={message.id}
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            background:
                              message.type === 'user'
                                ? currentPersonalityData.color
                                : '#f1f5f9',
                            color:
                              message.type === 'user' ? 'white' : '#1e293b',
                            padding: '15px',
                            borderRadius: '15px',
                            maxWidth: '80%',
                            wordWrap: 'break-word',
                          ...
                          {message.predictions && (
                            ...
                            >
                              ...
                              <p style={{ margin: 0, fontSize: '12px' }}>
                                Expected increase:{' '}
                                {message.predictions.earningsIncrease} in{' '}
                                {message.predictions.timeframe}
                              </p>
                            </div>
                          )}
                ...
                >
                  <div
                    className="aria-input-container"
                    style={{
                      display: 'flex',
                      gap: '10px',
                      marginBottom: '15px',
                  ...
                  >
                    {currentPersonality === 'advisor' && (
                      <>
                        <button
                          onClick={() =>
                            setInputMessage('How can I increase my earnings?')
                          }
                          style={{
                            background: 'white',
                        ...
                        <button
                          onClick={() =>
                            setInputMessage('Show me revenue optimization plan')
                          }
                          style={{
                            background: 'white',
                            border: `1px solid ${currentPersonalityData.color}`,
                    ...
                    {currentPersonality === 'analyzer' && (
                      <>
                        <button
                          onClick={() =>
                            setInputMessage('Analyze my network performance')
                          }
                          style={{
                            background: 'white',
                            border: `1px solid ${currentPersonalityData.color}`,
                        ...
                        <button
                          onClick={() =>
                            setInputMessage('Show team statistics')
                          }
                          style={{
                            background: 'white',
                            border: `1px solid ${currentPersonalityData.color}`,
                    ...
                    {currentPersonality === 'mentor' && (
                      <>
                        ...
                        <button
                          onClick={() =>
                            setInputMessage('Help me overcome challenges')
                          }
                          style={{
                            background: 'white',
                            border: `1px solid ${currentPersonalityData.color}`,
                    ...
                    {currentPersonality === 'strategist' && (
                      <>
                        <button
                          onClick={() =>
                            setInputMessage('Binary tree strategy advice')
                          }
                          style={{
                            background: 'white',
                            border: `1px solid ${currentPersonalityData.color}`,
                        ...
                        <button
                          onClick={() =>
                            setInputMessage('Long-term empire building plan')
                          }
                          style={{
                            background: 'white',
                            border: `1px solid ${currentPersonalityData.color}`,
