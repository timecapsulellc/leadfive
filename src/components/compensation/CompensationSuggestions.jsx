...
function CompensationSuggestions({ compensationData, selectedPackage, teamData }) {
  const suggestions = [];
  ...
  if (teamData && teamData.directReferrals < 10) {
    suggestions.push('Invite more direct referrals to unlock higher leader bonuses.');
  }
  ...
  return (
    <div className="compensation-suggestions" style={{marginTop:18,background:'#23263a',borderRadius:8,padding:'10px 16px',color:'#00d4ff',fontWeight:500}}>
