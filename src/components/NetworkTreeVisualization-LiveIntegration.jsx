    ...
    return (
      <div className={`network-tree-error ${currentTheme}`}>
        <div className="error-content">
          ...
          <p>{hasError}</p>
          {useLiveData && (
            <button className="retry-button" onClick={handleRefreshData}>
              🔄 Retry Connection
            </button>
          )}
        </div>
    ...
    >
      ...
      {showStats && useLiveData && networkStats && (
        <div className="live-stats">
          ...
          <div className="stat-item">
            ...
            <span className="stat-value">
              {networkStats.isPaused ? 'Paused' : 'Active'}
            </span>
          </div>
          {lastUpdate && (
            <div className="stat-item">
      ...
      {showStats && treeStats && (
        <div className="tree-stats">
          ...
          <div className="stat-item">
            ...
            <span className="stat-value">
              ${treeStats.totalVolume?.toLocaleString() || '0'}
            </span>
          </div>
        </div>
      )}
      ...
      {showNodeDetails && selectedNode && (
        <div className="node-details-panel">
          ...
          <div className="panel-content">
            ...
            {useLiveData &&
              selectedNode.attributes?.address &&
              !selectedNode.attributes?.isRoot && (
                <div className="panel-actions">
                  <button
                    className="action-button"
                    onClick={() =>
                      handleUserLookup(selectedNode.attributes.address)
                    }
                  >
                    🔍 Lookup User
                  </button>
      ...
      {showExport && (
        <div className="export-controls">
          <button className="export-button">📊 Export Tree</button>
        </div>
      )}
    </div>
  );
