        ...
        <div className="team-overview-content">
            <div className="team-stats-grid">
                ...
                <div className="team-stat-card">
                    ...
                    <div className="stat-info">
                        <h3>Team Volume</h3>
                        <div className="stat-value">${parseFloat(teamData.teamStats.totalVolume).toFixed(2)}</div>
                ...
                <div className="team-stat-card">
                    ...
                    <div className="stat-info">
                        <h3>Team Earnings</h3>
                        <div className="stat-value">${parseFloat(teamData.teamStats.teamEarnings).toFixed(2)}</div>
            ...
            <div className="team-levels">
                ...
                <div className="levels-grid">
                    <div className="level-card">
                        ...
                        <div className="level-count">{teamData.teamStats.levels[1] || 0}</div>
                        <div className="level-label">Direct Referrals</div>
                    </div>
                    <div className="level-card">
                        <div className="level-number">Level 2+</div>
                        <div className="level-count">{teamData.teamStats.levels[2] || 0}</div>
            ...
            <div className="referrals-header">
                ...
                <div className="referral-link">
                    ...
                    <div className="link-container">
                        ...
                        />
                        <button 
                            onClick={() => copyToClipboard(`${window.location.origin}?ref=${account}`)}
                            className="copy-btn"
                        >
                            📋 Copy
                        </button>
                    ...
                    teamData.recentActivity.map((member, index) => (
                        <div key={member.address} className="activity-item">
                            ...
                            <div className="activity-details">
                                ...
                                <div className="activity-date">{formatDate(member.joinDate)}</div>
                            </div>
                            <div className="activity-value">
                                ${parseFloat(ethers.formatEther(member.totalDeposits)).toFixed(2)}
                            </div>
                        </div>
                    ))
                )}
