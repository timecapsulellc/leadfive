  ...
  return (
    <div className="network-activity">
      ...
      <div className="activity-summary">
        <span>Total Members: <b>{teamData.totalMembers}</b></span>
        <span>Active Members: <b>{teamData.activeMembers}</b></span>
        <span>Direct Referrals: <b>{teamData.directReferrals}</b></span>
        <span>Leader Rank: <b>{teamData.leaderRank}</b></span>
      </div>
    </div>
  );
}
