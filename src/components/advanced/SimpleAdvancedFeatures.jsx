      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <p style={{ color: '#4a5568', lineHeight: 1.6, margin: 0 }}>
            Get personalized coaching advice, earnings forecasts, and strategic growth recommendations powered by AI.
          </p>
          <div style={{ 
            marginTop: '1rem', 
            padding: '0.75rem', 
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
            ...
            <h3 style={{ margin: 0, color: '#2d3748' }}>Real-Time Statistics</h3>
          </div>
          <p style={{ color: '#4a5568', lineHeight: 1.6, margin: 0 }}>
            Live network activity, team performance metrics, and transaction monitoring with 15-second updates.
          </p>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1rem' }}>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#2d3748' }}>94%</div>
              <div style={{ fontSize: '0.8rem', color: '#718096' }}>Network Health</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#2d3748' }}>Live</div>
              <div style={{ fontSize: '0.8rem', color: '#718096' }}>Updates</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
            ...
            <h3 style={{ margin: 0, color: '#2d3748' }}>Network Health Monitor</h3>
          </div>
          <p style={{ color: '#4a5568', lineHeight: 1.6, margin: 0 }}>
            Monitor smart contract performance, security metrics, and system status in real-time.
          </p>
          <div style={{ 
            marginTop: '1rem',
            display: 'flex',
            ...
            <span style={{ color: '#48bb78', fontWeight: 'bold' }}>All Systems Operational</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{ color: '#4a5568', lineHeight: 1.6, margin: 0 }}>
            Deep-dive into earnings breakdown, team performance, and comparison analytics with visual charts.
          </p>
          <div style={{ marginTop: '1rem' }}>
            <div style={{ fontSize: '0.8rem', color: '#718096', marginBottom: '0.3rem' }}>Earnings Growth</div>
            <div style={{ 
              width: '100%', 
              height: '8px', 
            ...
            <div style={{ fontSize: '0.8rem', color: '#48bb78', marginTop: '0.3rem', fontWeight: 'bold' }}>
              +32% this month
            </div>
          </div>
        </div>
