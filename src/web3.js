    ...
    try {
      ...
      return {
        ...
        totalEarnings: this.web3.utils.fromWei(
          userInfo.totalEarnings.toString(),
          'mwei'
        ), // 6 decimals
        withdrawable: this.web3.utils.fromWei(
          userInfo.withdrawable.toString(),
          'mwei'
        ),
  ...
  async getContractState() {
    try {
      ...
      return {
        ...
        totalVolume: this.web3.utils.fromWei(
          state.totalVolume.toString(),
          'mwei'
        ),
      };
    } catch (error) {
  ...
  async register(sponsorAddress, packageTier) {
    ...
    try {
      ...
      const tx = await this.contract.methods
        .register(sponsorAddress, packageTier)
        .send({
          from: this.account,
        });
