...
export function useLiveStats() {
  ...
  const [networkActivity, setNetworkActivity] = React.useState([
    {
      user: 'User_0x1a2b',
      action: 'joined with $100 package',
      time: '2 min ago',
      color: '#7B2CBF',
    },
    {
      user: 'User_0x3c4d',
      action: 'upgraded to $200 package',
      time: '5 min ago',
      color: '#00FF88',
    },
    {
      user: 'User_0x5e6f',
      action: 'earned $25 commission',
      time: '8 min ago',
      color: '#FF6B35',
    },
    {
      user: 'User_0x7g8h',
      action: 'joined with $50 package',
      time: '12 min ago',
      color: '#00D4FF',
    },
  ]);
      ...
      const interval = setInterval(() => {
        ...
        if (Math.random() < 0.3) {
          const newTransaction = {
            id: `tx_${Date.now()}`,
            type: ['deposit', 'withdrawal', 'commission', 'upgrade'][
