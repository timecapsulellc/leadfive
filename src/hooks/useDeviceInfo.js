...
export function useDeviceInfo() {
  ...
  const getResponsiveGrid = React.useCallback((itemCount, minWidth = 200) => {
  ...
  const getResponsiveFontSize = React.useCallback((baseSize = '1rem') => {
    if (deviceInfo.isMobile) {
  ...
  const getResponsiveSpacing = React.useCallback((baseSpacing = '1rem') => {
    if (deviceInfo.isMobile) {
