...
const securityFeatures = [
  {
    ...
    description:
      'Advanced multi-signature wallet protection with hardware key integration',
    details: [
  ...
  },
  {
    ...
    description:
      'PhD-level security audits by leading blockchain security experts',
    details: [
      ...
      <div className="page-content">
        <div className="page-header">
          ...
          <p className="page-subtitle">
            Bank-grade security powered by cutting-edge blockchain technology
          </p>
        </div>
        ...
        <div className="security-info-section">
          <div className="info-card">
            ...
            <p>
              LeadFive employs the highest standards of blockchain security,
              with multiple layers of protection to ensure your investments and
          ...
          <div className="info-card">
            ...
            <p>
              Our security team monitors the platform around the clock. If you
              notice any suspicious activity, contact our security hotline
              immediately.
            </p>
          </div>
        </div>
