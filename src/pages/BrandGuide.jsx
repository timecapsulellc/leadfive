...
const BrandGuide = ({ account, provider, signer, onConnect, onDisconnect }) => {
  ...
  const colorPalette = {
    primary: [
      { name: "Cyber Blue", hex: "#00D4FF", psychology: "Trust and innovation" },
      { name: "Royal Purple", hex: "#7B2CBF", psychology: "Premium quality and sophistication" },
      { name: "Energy Orange", hex: "#FF6B35", psychology: "Enthusiasm and growth potential" }
    ],
    secondary: [
      { name: "Deep Space", hex: "#1A1A2E", psychology: "Primary background color" },
      { name: "Midnight Blue", hex: "#16213E", psychology: "Secondary background" },
      { name: "Silver Mist", hex: "#B8C5D1", psychology: "Readable text color" }
    ],
    accent: [
      { name: "Success Green", hex: "#00FF88", psychology: "Positive metrics and achievements" },
      { name: "Alert Red", hex: "#FF4757", psychology: "Urgent calls-to-action" },
      { name: "Premium Gold", hex: "#FFD700", psychology: "VIP tiers and special offers" }
    ],
    neutral: [
      { name: "Pure White", hex: "#FFFFFF", psychology: "Clean backgrounds and text" },
      { name: "Charcoal Gray", hex: "#2D3748", psychology: "Secondary text and borders" },
      ...
      <div className="logo-versions">
        ...
        <div className="logo-variant">
          ...
          <div className="logo-preview transparent-bg">
            <svg width="150" height="150" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="mainGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <g transform="translate(200, 200)">
                ...
                <path d="M -80,-20 L 0,-60 L -30,-10 Z" fill="url(#darkGradient1)" opacity="0.7" />
                <path d="M 40,-80 L 80,-20 L 60,0 Z" fill="url(#mainGradient1)" />
                <path d="M 40,-80 L 60,0 L 0,-60 Z" fill="url(#darkGradient1)" opacity="0.7" />
                <path d="M 80,20 L 40,80 L 0,60 Z" fill="url(#mainGradient1)" />
                <path d="M 80,20 L 0,60 L 30,10 Z" fill="url(#darkGradient1)" opacity="0.7" />
                <path d="M -40,80 L -80,20 L -60,0 Z" fill="url(#mainGradient1)" />
                <path d="M -40,80 L -60,0 L 0,60 Z" fill="url(#darkGradient1)" opacity="0.7" />
          ...
          <p className="usage">Best for: Websites, overlays, digital platforms</p>
        </div>
        ...
        <div className="logo-variant">
          ...
          <div className="logo-preview dark-bg">
            <svg width="150" height="150" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="mainGradient2" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#00d4ff" />
                  <stop offset="50%" stopColor="#7b2cbf" />
                  <stop offset="100%" stopColor="#ff6b35" />
                </linearGradient>
              ...
              <g transform="translate(200, 200)">
                ...
                <path d="M -80,-20 L 0,-60 L -30,-10 Z" fill="url(#darkGradient2)" opacity="0.7" />
                <path d="M 40,-80 L 80,-20 L 60,0 Z" fill="url(#mainGradient2)" />
                <path d="M 40,-80 L 60,0 L 0,-60 Z" fill="url(#darkGradient2)" opacity="0.7" />
                <path d="M 80,20 L 40,80 L 0,60 Z" fill="url(#mainGradient2)" />
                <path d="M 80,20 L 0,60 L 30,10 Z" fill="url(#darkGradient2)" opacity="0.7" />
                <path d="M -40,80 L -80,20 L -60,0 Z" fill="url(#mainGradient2)" />
                <path d="M -40,80 L -60,0 L 0,60 Z" fill="url(#darkGradient2)" opacity="0.7" />
        ...
        <div className="logo-variant">
          ...
          <div className="logo-preview light-bg">
            <svg width="150" height="150" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="mainGradient3" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#00d4ff" />
                  <stop offset="50%" stopColor="#7b2cbf" />
                  <stop offset="100%" stopColor="#ff6b35" />
                </linearGradient>
              ...
              <g transform="translate(200, 200)">
                ...
                <path d="M -80,-20 L 0,-60 L -30,-10 Z" fill="url(#darkGradient3)" opacity="0.7" />
                <path d="M 40,-80 L 80,-20 L 60,0 Z" fill="url(#mainGradient3)" />
                <path d="M 40,-80 L 60,0 L 0,-60 Z" fill="url(#darkGradient3)" opacity="0.7" />
                <path d="M 80,20 L 40,80 L 0,60 Z" fill="url(#mainGradient3)" />
                <path d="M 80,20 L 0,60 L 30,10 Z" fill="url(#darkGradient3)" opacity="0.7" />
                <path d="M -40,80 L -80,20 L -60,0 Z" fill="url(#mainGradient3)" />
                <path d="M -40,80 L -60,0 L 0,60 Z" fill="url(#darkGradient3)" opacity="0.7" />
                <path d="M -30,-10 L 0,-60 L 30,10 L 0,60 Z" fill="#ffffff" stroke="#16213e" strokeWidth="2" />
              </g>
            </svg>
          </div>
    ...
    <div className="brand-guide-page">
      ...
      <div className="page-content">
        <div className="page-header">
          ...
          <p className="page-subtitle">Comprehensive brand identity and usage guidelines for the decentralized incentive network</p>
        </div>
        ...
        <div className="brand-content">
          ...
          <section className="brand-section">
            ...
            <p>Our logo represents innovation, trust, and the interconnected nature of blockchain technology.</p>
            <LogoShowcase />
          ...
          <section className="brand-section">
            ...
            <div className="typography-examples">
              <div className="type-example">
                ...
                <p>Font: 'Segoe UI', system-ui, sans-serif | Weight: 800 | Size: 3.2rem</p>
              </div>
              <div className="type-example">
                <h2 className="brand-h2">Heading 2 - Section Title</h2>
                <p>Font: 'Segoe UI', system-ui, sans-serif | Weight: 700 | Size: 2.4rem</p>
              </div>
              <div className="type-example">
                <h3 className="brand-h3">Heading 3 - Subsection</h3>
                <p>Font: 'Segoe UI', system-ui, sans-serif | Weight: 600 | Size: 1.8rem</p>
              </div>
              <div className="type-example">
                <p className="brand-body">Body Text - This is the standard paragraph text used throughout the platform.</p>
                <p>Font: 'Segoe UI', system-ui, sans-serif | Weight: 400 | Size: 1rem</p>
              </div>
            </div>
          </section>
          ...
          <section className="brand-section">
            ...
            <div className="application-examples">
              <div className="app-example">
                ...
                <p>Use Deep Space (#1A1A2E) background with Silver Mist (#B8C5D1) text</p>
              </div>
              <div className="app-example">
                <h4>Buttons & CTAs</h4>
                <p>Primary gradient: Cyber Blue to Royal Purple with Energy Orange accents</p>
              </div>
              <div className="app-example">
                <h4>Status Indicators</h4>
                <p>Success Green for positive, Alert Red for warnings, Premium Gold for premium features</p>
              </div>
              <div className="app-example">
                <h4>Social Media</h4>
                <p>Use high-contrast logo versions, maintain brand colors in all posts</p>
              </div>
            </div>
          </section>
          ...
          {account && (
            <section className="brand-section">
              ...
              <div className="download-section">
                <p>Access high-resolution logos, color swatches, and brand templates:</p>
                <div className="download-buttons">
                  <button className="download-btn primary">Logo Package (.ZIP)</button>
                  <button className="download-btn secondary">Color Palette (.ASE)</button>
                  <button className="download-btn secondary">Brand Template (.PSD)</button>
                </div>
              </div>
            </section>
          )}
